...
def train_network():
    ...
    fake_img_val = lasagne.layers.get_output(disc, {disc["input_dis"] : lasagne.layers.get_output(gen), disc["text_input_dis"] : InputLayer(shape = (None, 11, 300), input_var = input_text)})
