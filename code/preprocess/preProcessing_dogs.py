...
train = np.load('/home/utkarsh1404/project/text2image/data/dogs/img_to_caption_train.npy').item()
validate = np.load('/home/utkarsh1404/project/text2image/data/dogs/img_to_caption_validate.npy').item()
test = np.load('/home/utkarsh1404/project/text2image/data/dogs/img_to_caption_test.npy').item()
...
np.save('/home/utkarsh1404/project/text2image/data/dogs/system_input_train.npy', train_vec)
np.save('/home/utkarsh1404/project/text2image/data/dogs/system_input_validate.npy', validate_vec)
np.save('/home/utkarsh1404/project/text2image/data/dogs/system_input_test.npy', test_vec)
